...
def main():
    ...
    with consent:
        ...
        st.write("""
    Please read the following consent information carefully.

    By checking the box below, you agree to participate in this usability test. Your data will be collected anonymously and used solely for educational purposes.
    """)
    ...
    with demographics:
        ...
        with st.form("demographic_form"):
            ...
            familiarity = st.radio(
                "How familiar are you with similar usability testing tools?",
    ...
    with exit:
        ...
        with st.form("exit_form"):
            satisfaction = st.slider("How satisfied were you with the app?", 1, 5)
            difficulty = st.slider("How difficult was it to complete the tasks?", 1, 5)
            open_feedback = st.text_area("Do you have any additional feedback or suggestions?")
